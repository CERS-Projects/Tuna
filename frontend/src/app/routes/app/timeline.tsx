...
const PostDummy: PostDataItem[] = [
  ...
  },
  {
    ...
    userId: "u004",
    userName: "公式ニュース",
    iconUrl: "https://placehold.co/100x100/red/white?text=News",
    mainPost:
      "【重要なお知らせ】\n来週の月曜日はメンテナンスのため、午前2時から4時までサービスが利用できません。ご迷惑をおかけしますがよろしくお願いします。",
    goodCount: 56,
    commentCount: 2,
    goodCheck: false,
    bookmarkCheck: false,
    postTo: "2024/12/06 09:00",
    userTo: "@official_news",
    // postImgsもiconUrlもありパターン
  },
  {
    postId: 5,
    userId: "u005",
    userName: "佐藤 花子",
    iconUrl: "https://placehold.co/100x100/purple/white?text=H",
    mainPost: "猫がキーボードの上で寝てしまって仕事ができない...😂",
    goodCount: 890,
    commentCount: 45,
    goodCheck: false,
    bookmarkCheck: false,
    ...
    userTo: "@hanako_sato",
    postImgs: [
      "https://placehold.co/600x400/ddd/333?text=Cat+On+Keyboard",
      "https://placehold.co/600x400/ddd/333?text=Sleeping+Face",
      "https://placehold.co/600x400/ddd/333?text=Paw",
    ],
  },
  {
    postId: 1,
