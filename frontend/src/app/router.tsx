...
const createAppRouter = (queryClient: QueryClient) => {
	...
	return createBrowserRouter([
		...
		route(paths.inquiry.complete.path, () => import("./routes/completeInquiry")),
					...
					children: [
						{
							...
							children: [
								...
								route(paths.app.test.path, () => import("./routes/app/test")),
								{
									...
									lazy: () => import("./routes/app/timeline").then(convert(queryClient)),
									children: [
										route(
									...
									children: [
										{
											index: true,
											element: (
												<Navigate to={paths.app.management.classroom.list.path} replace />
											),
										},
										route(
