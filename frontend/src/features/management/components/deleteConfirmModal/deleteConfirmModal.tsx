...
export const DeleteConfirmModal = ({
  ...
  const reasonLabel = report
    ? (reasonLabels[report.reasonId]?.label ?? "不明")
    : "";
          ...
          <table className={styles.reportInfo}>
            <tbody>
              <tr>
                <th>通報者</th>
                <td>
                  {report.reportByName}（@{report.reportByShowUserId}）
                </td>
              </tr>
              <tr>
                <th>通報対象</th>
                <td>
                  {report.reportedName}（@{report.reportedShowUserId}）
                </td>
              </tr>
              <tr>
                <th>通報理由</th>
