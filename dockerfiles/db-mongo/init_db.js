...
try{
    ...
    validator: {
      $jsonSchema: {
        ...
        properties: {
          ...
          icon: {
            bsonType: "string",
            description: "ユーザアイコンの保存場所のPath アイコンはクラウド上に保存する"
          },
          show_user_id: {
            bsonType: "string",
            minLength: 1,
      ...
      $jsonSchema: {
        ...
        properties: {
          ...
          bookmark: {
            ...
            description: "お気に入りの投稿を保存するためのもの 配列の要素には投稿のobjectIdが入る"
          }
        }
      }
    }
    ...
    validator: {
      $jsonSchema: {
        ...
        properties: {
          follower_id: {
            bsonType: "int",
            description: "フォローしているユーザーのMySQLに定義されている一意のuser_id"
          },
          following_id: {
            bsonType: "int",
            description: "フォローされているユーザーのMySQLにて議されている一意のuser_id"
          },
          created_at: {
            bsonType: "date",
        ...
        properties: {
          ...
          goods: {
            ...
            items: {
              bsonType: "objectId",
              minimum: 1,
              description: "指定したユーザがいいねした投稿のオブジェクトIDを格納"
            }
          }
        }
      }
  ...
  db.createCollection("inqury_collection",{
    validator: {
      $jsonSchema: {
        bsonType: "object",
        required: [
...
try {
    ...
    db.search_history_collection.insertMany([
        { 
            ...
            search_history: [
                ...
                { query: "英語 スピーキング", search_date: new Date(Date.now() - 600000) }
            ] 
        },
        { 
            user_id: 103, 
    ...
    db.bookmark_collection.insertMany([
        ...
        { 
            user_id: 102, 
            bookmark: [
                new ObjectId("600000000000000000000003")
            ] 
        }
    ]);
    ...
    db.goods_collection.insertMany([
        ...
        { 
            user_id: 102, 
            goods: [
                new ObjectId("600000000000000000000007")
            ] 
        }
    ]);
        ...
        { 
            ...
            categorys: [
                { 
                    category: "図形", 
                    documents: [
                        { name: "三角関数資料", path: "path/fig/doc1.pdf", upload_date: new Date() }
                    ] 
                }
            ]
        },
    ...
    // K. inqury_collection (問い合わせ)
    db.inqury_collection.insertMany([
        { 
            inqury_id: 801, 
            datetime: new Date(), 
            subject: "アカウント関連の質問", 
    ...
    print("✅ inqury_collectionに2件挿入しました。");
