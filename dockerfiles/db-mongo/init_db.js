...
try {
  ...
  db.post_collection.insertMany([
    ...
    {
      user_id: 12,
      post_date: new Date(Date.now() - 240000),
      sentence: "2年生の高橋です！2-A組になりました、よろしくお願いします！",
      like_count: 0,
      response_count: 0,
      share_range: [8, 11],
      response_to: null,
    ...
    {
      user_id: 13,
      post_date: new Date(Date.now() - 200000),
      sentence: "渡辺です。2-B組です、今年もよろしく！",
      like_count: 0,
      response_count: 0,
      share_range: [8, 12],
      response_to: null,
    ...
    {
      user_id: 14,
      post_date: new Date(Date.now() - 180000),
      sentence: "1年生の中村です。1-A組よろしくー！",
      like_count: 0,
      response_count: 0,
      share_range: [9, 13],
      response_to: null,
    ...
    {
      user_id: 15,
      post_date: new Date(Date.now() - 150000),
      sentence: "伊藤です！1-B組一年間よろしくお願いします！",
      like_count: 0,
      response_count: 0,
      share_range: [9, 14],
      response_to: null,
    ...
    // --- school_id=3 追加投稿 ---
    {
      _id: ObjectId("669a84a2c914e6b7f329d601"),
      user_id: 8,
      post_date: new Date(Date.now() - 120000),
      sentence:
        "今日の授業めっちゃ難しかった...Javaのインターフェースが全然わからん",
      like_count: 3,
      response_count: 2,
      share_range: [7, 10],
      response_to: null,
    ...
    {
      user_id: 9,
      post_date: new Date(Date.now() - 110000),
      sentence:
        "わかる！俺もインターフェースで詰まったわ。放課後一緒に勉強しない？",
      like_count: 1,
      response_count: 0,
      share_range: [7, 10],
      response_to: ObjectId("669a84a2c914e6b7f329d601"),
      post_flag: true,
    },
    {
      user_id: 7,
      post_date: new Date(Date.now() - 100000),
      sentence:
        "インターフェースで困ってる人は放課後に補習やるので教室に来てください！",
      like_count: 5,
      response_count: 0,
      share_range: [7, 10],
      response_to: ObjectId("669a84a2c914e6b7f329d601"),
    ...
    {
      _id: ObjectId("669a84a2c914e6b7f329d604"),
      user_id: 12,
      post_date: new Date(Date.now() - 95000),
      sentence: "2年生になって科目増えすぎ！データベースの授業が一番楽しい",
      like_count: 4,
      response_count: 2,
      share_range: [8, 11],
      response_to: null,
    ...
    {
      user_id: 13,
      post_date: new Date(Date.now() - 90000),
      sentence: "データベースいいよね！SQLめっちゃ面白い",
      like_count: 2,
      response_count: 0,
      share_range: [8, 12],
      response_to: ObjectId("669a84a2c914e6b7f329d604"),
      post_flag: true,
    },
    {
      user_id: 12,
      post_date: new Date(Date.now() - 85000),
      sentence: "JOINが最初わからなかったけど図で書いたら理解できた！",
      like_count: 1,
      response_count: 0,
      share_range: [8, 11],
      response_to: ObjectId("669a84a2c914e6b7f329d604"),
    ...
    {
      _id: ObjectId("669a84a2c914e6b7f329d607"),
      user_id: 14,
      post_date: new Date(Date.now() - 80000),
      sentence:
        "入学して1週間たったけど、まだ学校に慣れない...先輩たちはみんな優しい！",
      like_count: 6,
      response_count: 3,
      share_range: [9, 13],
      response_to: null,
    ...
    {
      user_id: 15,
      post_date: new Date(Date.now() - 75000),
      sentence: "俺も最初は不安だったけどもう慣れたよ！一緒に頑張ろう！",
      like_count: 2,
      response_count: 0,
      share_range: [9, 14],
      response_to: ObjectId("669a84a2c914e6b7f329d607"),
      post_flag: true,
    },
    {
      user_id: 12,
      post_date: new Date(Date.now() - 70000),
      sentence: "1年生の子たち頑張ってるね！困ったことあったらいつでも聞いてね",
      like_count: 3,
      response_count: 0,
      share_range: [8, 11],
      response_to: ObjectId("669a84a2c914e6b7f329d607"),
    ...
    {
      user_id: 8,
      post_date: new Date(Date.now() - 65000),
      sentence:
        "3年生の先輩として言うと、最初の半年乗り越えたら楽しくなるから！",
      like_count: 4,
      response_count: 0,
      share_range: [7, 10],
      response_to: ObjectId("669a84a2c914e6b7f329d607"),
    ...
    {
      _id: ObjectId("669a84a2c914e6b7f329d60b"),
      user_id: 6,
      post_date: new Date(Date.now() - 60000),
      sentence:
        "来週の月曜日は全学年合同のガイダンスがあります。全員参加してください。",
      like_count: 2,
      response_count: 1,
      share_range: [7, 8, 9],
      response_to: null,
    ...
    {
      user_id: 9,
      post_date: new Date(Date.now() - 55000),
      sentence: "了解です！場所はいつもの大教室ですか？",
      like_count: 0,
      response_count: 0,
      share_range: [7, 10],
      response_to: ObjectId("669a84a2c914e6b7f329d60b"),
      post_flag: true,
    },
    {
      user_id: 10,
      post_date: new Date(Date.now() - 50000),
      sentence:
        "3-A組の皆さん、来週の課題の提出期限は金曜日までです。忘れずに！",
      like_count: 1,
      response_count: 0,
      share_range: [10],
      response_to: null,
    ...
    {
      user_id: 13,
      post_date: new Date(Date.now() - 45000),
      sentence: "今日のお昼は学食のカレーが最高だった！毎日食べたい",
      like_count: 8,
      response_count: 0,
      share_range: [8, 12],
      response_to: null,
    ...
    {
      user_id: 8,
      post_date: new Date(Date.now() - 40000),
      sentence:
        "チーム開発のプロジェクト始まった！SpringBootとReactで作るらしい",
      like_count: 7,
      response_count: 0,
      share_range: [7, 10],
      response_to: null,
    ...
    {
      user_id: 15,
      post_date: new Date(Date.now() - 35000),
      sentence:
        "プログラミングの課題終わらない...HTMLとCSSだけでこんなに大変なの？",
      like_count: 3,
      response_count: 0,
      share_range: [9, 14],
      response_to: null,
    ...
    {
      _id: ObjectId("669a84a2c914e6b7f329d611"),
      user_id: 14,
      post_date: new Date(Date.now() - 30000),
      sentence: "今日の体育でバドミントンやった！めっちゃ楽しかった",
      like_count: 5,
      response_count: 1,
      share_range: [9, 13],
      response_to: null,
    ...
    {
      user_id: 15,
      post_date: new Date(Date.now() - 25000),
      sentence: "バドミントンいいな！1-B組は来週やるらしい、楽しみ！",
      like_count: 1,
      response_count: 0,
      share_range: [9, 14],
      response_to: ObjectId("669a84a2c914e6b7f329d611"),
      post_flag: true,
    },
    {
      user_id: 9,
      post_date: new Date(Date.now() - 20000),
      sentence: "就活の準備始めないとやばい...ポートフォリオ何作ろう",
      like_count: 2,
      response_count: 0,
      share_range: [7, 10],
      response_to: null,
    ...
    {
      user_id: 7,
      post_date: new Date(Date.now() - 15000),
      sentence:
        "明日の3-A組のJavaの授業は例外処理をやります。教科書の第8章を予習しておいてください。",
      like_count: 0,
      response_count: 0,
      share_range: [10],
      response_to: null,
    ...
    {
      user_id: 12,
      post_date: new Date(Date.now() - 10000),
      sentence: "テスト近いのに全然勉強してない...やばいかも",
      like_count: 6,
      response_count: 0,
      share_range: [8, 11],
      response_to: null,
    ...
    {
      user_id: 11,
      post_date: new Date(Date.now() - 5000),
      sentence:
        "3年生の皆さん、卒業制作のテーマ提出は今月末が締め切りです。早めに準備しましょう。",
      like_count: 3,
      response_count: 0,
      share_range: [7],
      response_to: null,
  ...
  print("✅ post_collectionに38件挿入しました。");
